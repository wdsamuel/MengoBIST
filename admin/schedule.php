...
<body>
                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@mengo.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                         ...
                                         for ( $x=0; $x<$result->num_rows;$x++){
                                             ...
                                             echo '<tr style="text-align:center;">
                                                ...
                                                '.substr($pid,0,15).'
                                                 ...
                                                 <td>
                                                 <button type="button" class="login-btn btn-primary-soft btn" onclick="window.print();">Print Badge</button>
                                                 </td>
    ...
    <script>
    function printAppointment(modalId) {
